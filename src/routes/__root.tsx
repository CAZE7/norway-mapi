...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Steder i Norge – Interaktive Norwegen-Karte" },
      {
        name: "description",
        content:
          "Entdecke Norwegens Fjorde, Berge, Wasserfälle und Camper-Plätze auf einer interaktiven Karte mit Suche, Filtern, Favoriten und Routenplanung.",
      },
      { name: "author", content: "Steder i Norge" },
      { property: "og:title", content: "Steder i Norge" },
      {
        property: "og:description",
        content: "Interaktive Karte für Reisen durch Norwegen.",
      },
